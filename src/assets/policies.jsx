  ...
  sections: [
    {
      heading: "Overview",
      content: `
        This website is operated by M/s Mirai Enterprises. Throughout the site, the terms “we”, “us” and “our” refer to M/s Mirai Enterprises. M/s Mirai Enterprises offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
        <br/><br/>
...
that we can complete your transactions and contact you as needed. <br/><br/>
...
optional third-party tools. <br/><br/>
...
which tools are provided by the relevant third-party provider(s). <br/><br/>
...
compensation for any comments; or (3) to respond to any comments. <br/><br/>
...
In no case shall M/s Mirai Enterprises, our directors, officers, employees, affiliates, agents,
...
jurisdictions, our liability shall be limited to the maximum extent permitted by law.
    ...
    },
    {
      ...
      content: `
        You agree to indemnify, defend and hold harmless M/s Mirai Enterprises and our parent,
...
use our Services, or when you cease using our site. <br/><br/>
...
not limited to, any prior versions of the Terms of Service). <br/><br/>
...
acceptance of those changes.
    ...
    },
    {
      ...
      content: `
        Questions about the Terms of Service should be sent to us at <a href="mailto:hello@umimatchashop.com">hello@umimatchashop.com</a> . <br/><br/> Our contact information is posted below:
        M/s Mirai Enterprises<br/>
        Phone: <a href="tel:9568480048">+91 9568480048</a>
      `,
    },
    {
      heading: "Changes to This Policy",
      content: `We may update these terms from time to time, including to reflect changes to our practices or
for other operational, legal, or regulatory reasons. We will post the revised terms on the Site,
...
export const privacyPolicy = {
  ...
  sections: [
    ...
    },
    {
      heading: "Cookies",
      content: `
        Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies">Shopify Cookie Policy</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
        <br/><br/>
    ...
    },
    {
      ...
      content: `
        ...
        <ul>
          <li>With vendors or other third parties who perform services on our behalf (e.g., IT
management, payment processing, data analytics, customer support, cloud storage,
fulfillment and shipping).
</li>
          <li>With business and marketing partners to provide services and advertise to you. Our
business and marketing partners will use your information in accordance with their
own privacy notices.</li>
...
media widgets or login integrations, with your consent.</li>
          <li>With our affiliates or otherwise within our corporate group, in our legitimate interests
to run a successful business.</li>
...
protect or defend the Services, our rights, and the rights of our users or others.</li>
        </ul>
        <br/>
        We disclose the following categories of personal information and sensitive personal
information about users for the purposes set out above in <em>"How we Collect and Use your
Personal Information"</em> and <em>"How we Disclose Personal Information" </em>:
</br>
</br>
    ...
    },
    {
      ...
      content: `
        Our Site may provide links to websites or other online platforms operated by third parties. If
you follow links to sites not affiliated or controlled by us, you should review their privacy
...
reliability of information found on these sites. Information you provide on public or semipublic venues, including information you share on third-party social networking platforms
may also be viewable by other users of the Services and/or users of those third-party
platforms without limitation as to its use by us or by a third party. Our inclusion of such links
does not, by itself, imply any endorsement of the content on such platforms or of their owners
...
provided us with their personal information, you may contact us using the contact details set
out below to request that it be deleted. <br/><br/>
...
guarantee “perfect security.” In addition, any information you send to us may not be secure
while in transit. We recommend that you do not use insecure channels to communicate
sensitive or confidential information to us. <br/><br/>
How long we retain your personal information depends on different factors, such as whether
we need the information to maintain your account, to provide the Services, comply with legal
obligations, resolve disputes or enforce other applicable contracts and policies.
      `,
    },
    {
      heading: "Your Rights",
      content: `
        ...
        <ul>
          ...
          <li><strong>Right to Correct / Know:</strong> : You may have a right to request that we correct inaccurate personal information we maintain about you.</li>
          <li><strong>Right to Portability :</strong> : You may have a right to receive a copy of the personal information we hold about you and to request that we transfer it to a third party, in certain circumstances and with certain exceptions</li>
          ...
          <li><strong>Appeal:</strong>: You may have a right to appeal our decision if we decline to process your
request. You can do so by replying directly to our denial.
</li>
          <li><strong>Managing Communication Preferences </strong> : We may send you promotional emails, and
you may opt out of receiving these at any time by using the unsubscribe option
displayed in our emails to you. If you opt out, we may still send you non-promotional
emails, such as those about your account or orders that you have made.</li>
        </ul>
        You may exercise any of these rights where indicated on our Site or by contacting us using
the contact details provided below. <br/><br/>
We will not discriminate against you for exercising any of these rights. We may need to
collect information from you to verify your identity, such as your email address or account
information, before providing a substantive response to the request. In accordance with
...
contacting us using the contact details set out below, or lodge your complaint with your local
...
country you live in. Your personal information is also processed by staff and third party
service providers and partners in these countries. <br/><br/>
If we transfer your personal information out of Europe, we will rely on recognized transfer
mechanisms like the European Commission's Standard Contractual Clauses, or any
equivalent contracts issued by the relevant competent authority of the UK, as relevant, unless
the data transfer is to a country that has been determined to provide an adequate level of
protection.
  ...
  sections: [
    {
      heading: "Introduction",
      content: `
        At Umi (Mirai Enterprises), we strive to ensure that every order reaches you in perfect condition. Please read our return and refund policy carefully before making a purchase.
      `,
    },
    {
